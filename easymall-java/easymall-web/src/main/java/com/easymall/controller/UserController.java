...
public class UserController {
     ...
     */
    @GetMapping("/info")
    public Result<UserDTO.Response> getInfo(@CurrentUserId String userId) {
     ...
     */
    @PutMapping("/info")
    public Result<String> updateProfile(@CurrentUserId String userId,
     ...
     */
    @PutMapping("/password")
    public Result<String> changePassword(@CurrentUserId String userId,
